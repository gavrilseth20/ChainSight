        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-xs">
              Advanced RegTech solution for detecting money laundering patterns in blockchain transactions using Graph Neural Networks.
            </p>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {currentYear} SmurfPakad. All rights reserved.
              ~ Distributed By <a href="https://themewagon.com/" target="_blank" rel="noopener noreferrer" className="text-crypto-purple hover:underline">ThemeWagon</a>
            </p>
